<template>
  <view class="app">
        ...
        <view class="money-item item-ma" @click="selectPayCardPopShow = true">
          ...
          <view class="content" v-if="userInfo.bankList">
            ...
            <view class="tips">
              <view
                >可用余额 ￥{{
                  formatAmount(userInfo.bankList[0].accountBalance)
                }}</view
              >
              <image
                class="tooltip-icon"
    ...
    <selectPayCardPop
      :show="selectPayCardPopShow"
      @close="selectPayCardPopShow = false"
    ></selectPayCardPop>
    <payPasswordPop
      :contactsInfo="contactsInfo"
      :money="money"
      :purpose="purpose"
      @close="payPasswordPopShow = false"
      :show="payPasswordPopShow"
    >
    </payPasswordPop>
    <transferRemarkPop
      @confirm="transferRemarkcConfirm"
      :show="transferRemarkPopShow"
      @close="transferRemarkPopShow = false"
    ></transferRemarkPop>
  </view>
</template>
...
import { navigateTo, formatAmount } from "@/utils/index.js";
