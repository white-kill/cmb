		...
		<navbar ai-btn more-btn :placeholder="false" :bg-color="`rgba(255,255,255,${1-opacity})`">
			<slot>
				<view class="nav-content" :style="{height:`${navBarHeight}px`}">
					<view class="nav-search" :style="{border:opacity<1?'1rpx solid #B3B4CA': '1rpx solid #B3B4CA'}">
...
<style scoped lang="scss">
	.pages {
		width: 750rpx;
		height: 4230rpx;
		background-image: url(/static/pages/jj.png);
		background-position: top;
		background-repeat: no-repeat;
		background-size: 750rpx 4230rpx;
	}
